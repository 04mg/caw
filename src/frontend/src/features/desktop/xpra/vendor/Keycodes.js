...
const CHARCODE_TO_NAME_SHIFTED = {};
...
// ESM exports (added for Caw bundling). The original file attaches these
// names to the global scope; we expose the subset our client uses.
export {
  KEY_TO_NAME,
  DEAD_KEYS,
  NUMPAD_TO_NAME,
