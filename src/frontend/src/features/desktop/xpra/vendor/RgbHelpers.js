 ...
 *
 * Vendored from https://github.com/Xpra-org/xpra-html5 (html5/js/RgbHelpers.js)
 * and converted to an ES module for bundling in Caw.
 */
...
export function rgb24_to_rgb32(data, width, height, rowstride) {
  const uint = new Uint8Array(width * height * 4)
  let source_index = 0
  let target_index = 0
