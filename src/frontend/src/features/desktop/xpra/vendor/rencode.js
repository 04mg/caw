...
// ESM exports (added for Caw bundling; the original file is a plain script
// that attaches these names to the module / global scope).
export { rencode, rdecode, rencode_selftest, DecodeBuffer }
