...
type LayoutNode struct {
	...
	// (default; xterm.js over the PTY WS) or "editor" (Monaco diff/file
	// view). Existing leaves with a filePath/isDiff normalize to "editor";
	// all others default to "terminal".
